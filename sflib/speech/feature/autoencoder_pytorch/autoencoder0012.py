...
class SpectrogramImageAutoEncoder0012Pytorch(SpectrogramImageAutoEncoder):
    def __init__(self):
        super(SpectrogramImageAutoEncoder0012Pytorch, self).__init__()
