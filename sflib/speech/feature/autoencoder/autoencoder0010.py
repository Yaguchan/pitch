...
class SpectrogramImageAutoEncoder0010(SpectrogramImageAutoEncoder):
    def __init__(self):
        super().__init__()
        ...
        x = Activation('relu')(x)
        # CNN-1
        x = Conv2D( 8, (5, 5), activation='relu', padding='same', strides=(2, 2),
                   kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # CNN-2
        x = Conv2D(12, (7, 5), activation='relu', padding='same', strides=(3, 2),
                   kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # CNN-3
        x = Conv2D(18, (7, 5), activation='relu', padding='same', strides=(3, 2),
                   kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # CNN-4
        x = Conv2D(28, (7, 5), activation='relu', padding='same', strides=(3, 2),
                   kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # FC-1
        x = Flatten()(x)
        ...
        x = BatchNormalization()(x)
        # Inverse FC-1
        x = Dense(10 * 1 * 28, activation='relu',
                  kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # Inverse CNN-4
        x = Reshape((10, 1, 28))(x)
        x = Conv2DTranspose(18, (7, 5), activation='relu', padding='same',
                            strides=(3, 2),
                            kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # Inverse CNN-3
        x = Conv2DTranspose(12, (7, 5), activation='relu', padding='same',
                            strides=(3, 2),
                            kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # Inverse CNN
        x = Conv2DTranspose(8, (7, 5), activation='relu', padding='same',
                            strides=(3, 2),
                            kernel_initializer='he_normal', bias_initializer='zeros')(x)
        x = BatchNormalization()(x)
        # Inverse CNN-1
