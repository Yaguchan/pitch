...
class SpectrogramImageAutoEncoderTrainerCSJ0002(
    ...
    def build_data(self):
        sia = SpectrogramImageArrayWithVAD(
            cond='A', tag='VAD-L', max_wav_num_for_each_file=100, shuffle=True)
        sia.construct()
...
def train(autoencoder_version):
    ...
    autoencoder = cls()
    trainer = SpectrogramImageAutoEncoderTrainerCSJ0002()
