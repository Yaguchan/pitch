...
# GlobalAveragePookingしたベクトルをそのままボトルネック特徴量（128次元）とする
...
class SpectrogramImageAutoEncoder0016(SpectrogramImageAutoEncoder):
    def __init__(self):
        super().__init__()
        ...
        x = Activation('relu')(x)
        # CNN-1
        x = buildResNetBlock(x, 16, (5, 5), (2, 2))
        # CNN-2
        x = buildResNetBlock(x, 32, (7, 5), (3, 2))
        # CNN-3
        x = buildResNetBlock(x, 64, (7, 5), (3, 2))
        # CNN-4
        x = buildResNetBlock(x, 128, (7, 5), (3, 2))
        # FC-1
        ...
        x = buildResNetBlockDeconv(x, 64, (7, 5), (3, 2))
        # Inverse CNN-3
        x = buildResNetBlockDeconv(x, 32, (7, 5), (3, 2))
        # Inverse CNN-2
        x = buildResNetBlockDeconv(x, 16, (7, 5), (3, 2))
        # Inverse CNN-1
        x = buildResNetBlockDeconv(x, 1, (5, 5), (2, 2))
        # Cropping
