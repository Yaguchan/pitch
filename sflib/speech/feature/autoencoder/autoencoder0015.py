...
# ResNet風で，kernel_size=3,3で統一．あまり成績はよくなかった.
...
class SpectrogramImageAutoEncoder0015(SpectrogramImageAutoEncoder):
    def __init__(self):
        super().__init__()
        ...
        # CNN-2
        x = buildResNetBlock(x, 32, (5, 3), (3, 2))
        # CNN-3
        x = buildResNetBlock(x, 64, (5, 3), (3, 2))
        # CNN-4
        x = buildResNetBlock(x, 128, (5, 3), (3, 2))
        # FC-1
        ...
        x = buildResNetBlockDeconv(x, 64, (5, 3), (3, 2))
        # Inverse CNN-3
        x = buildResNetBlockDeconv(x, 32, (5, 3), (3, 2))
        # Inverse CNN-2
        x = buildResNetBlockDeconv(x, 16, (5, 3), (3, 2))
        # Inverse CNN-1
        x = buildResNetBlockDeconv(x, 1, (3, 3), (2, 2))
        # Cropping
