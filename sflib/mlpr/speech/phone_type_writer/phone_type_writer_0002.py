...
class PhoneTypeWriter0002(PhoneTypeWriter):
    ...
    def _build(self):
        ...
        inner = TimeDistributed(Dense(128, activation='relu',
                                      name='dense1'))(input_data)
        inner = TimeDistributed(Dense(64, activation='relu',
                                      name='dense2'))(inner)
        inner = LSTM(
            64, return_sequences=True, activation='relu', name='lstm1')(inner)
        inner = TimeDistributed(Dense(32, name='dense3', activation='relu'))(inner)
