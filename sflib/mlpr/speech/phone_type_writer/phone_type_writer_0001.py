...
class PhoneTypeWriter0001(PhoneTypeWriter):
    ...
    def _build(self):
        ...
        inner = LSTM(
            32, return_sequences=True, activation='relu', name='lstm1')(inner)
        inner = TimeDistributed(Dense(len(phone_list), name='dense2'))(inner)
