...
class PhoneTypeWriterTrainerCSJ0003(PhoneTypeWriterTrainer):
    ...
    def _build(self):
        ...
        train_sia = SpectrogramImageArrayWithVADPhones(
            cond='A.*[^1]$', max_wav_num_for_each_file=100, image_shift=1)
        ...
        validation_sia = SpectrogramImageArrayWithVADPhones(
            cond='A.*1$', max_wav_num_for_each_file=10, image_shift=1)
...
def train_with_autoencoder(phone_type_writer_version,
    ...
    trainer = PhoneTypeWriterTrainerCSJ0003(phone_type_writer)
    trainer.train()
