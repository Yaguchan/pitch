...
class PhoneTypeWriterTrainerCSJRWCP0004(PhoneTypeWriterTrainer):
...
def train_mfcc0001():
    ...
    from .phone_type_writer_0003 \
        import PhoneTypeWriter0003 as PhoneTypeWriter
    from . import base as ab
    feature_extractor = FeatureExtractor()
    phone_type_writer = PhoneTypeWriter(feature_extractor)
    trainer = PhoneTypeWriterTrainerCSJRWCP0004(phone_type_writer)
    trainer.train()
