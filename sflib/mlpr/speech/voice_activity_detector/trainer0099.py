...
class VoiceActivityDetectorTrainer0099(VoiceActivityDetectorTrainer):
    ...
    def build_torch_trainer(self,
        ...
        id_list_train = waseda_soma.get_id_list()[:300:30]
        dataset_train = DurationInfoDataset(dim, id_list_train)
        
        id_list_vali = waseda_soma.get_id_list()[300:310:10]
