...
class CollateDurationInfo:
    def __init__(self, frame_rate, noise_adder: NoiseAdder = None):
...
class TurnDetectorTrainer0001(TurnDetectorTrainer):
    def __init__(self):
        super().__init__()
    ...
    def build_torch_trainer(self, turn_detector: TurnDetector):
        ...
        collate_fn_trainer = CollateDurationInfo(
            turn_detector.feature_extractor.feature_rate, noise_adder)
