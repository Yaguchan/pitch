...
class FacialTurnDetectorModel(FacialTurnDetectorTorchModel):
    def __init__(self, in_feature_dim, frame_window=10, cnn_out_channels=10):
        ...
        self.linear_in1 = nn.Linear(cnn_out_channels * self._feature_dim, 32)
        self.linear_in1b = nn.BatchNorm1d(32)
        self.lstm1 = nn.LSTM(32, 32)
        self.linear_1 = nn.Linear(32, 16)
        self.linear_1b = nn.BatchNorm1d(16)
        self.linear_out_turn = nn.Linear(16, 2)  # 0 (OFF), 1 (ON)
...
class FacialTurnDetector0003(FacialTurnDetector):
    def __init__(self,
