...
class FacialTurnDetectorTrainerRinus0003(FacialTurnDetectorTrainer):
...
def tmp_setup(device='cuda'):
    ...
    feature_extractor = FacialTurnDetectorFeatureExtractor0003(
    ...
    trainer = FacialTurnDetectorTrainerRinus0003(facial_turn_detector,
                                                 train_groups=cvlist[1][0],
                                                 validation_group=cvlist[1][1],
                                                 test_group=cvlist[1][2])
    return trainer
...
def train_and_test_frame_window_changing(constructor, device='cuda'):
    for frame_window in (5, 10, 15, 20, 25, 30):
    # for frame_window in (25, 30):
        print("FRAME WINDOW {}".format(frame_window))
        cvlist = generate_cross_validataion_list()
        for i, cv in enumerate(cvlist):
            print("No. {} (TEST GROUP {}) STARTED".format(i, cv[2]))
            trainer = constructor(train_groups=cv[0],
...
def train_and_test_cnn_out_channels_changing(constructor, device='cuda'):
    frame_window = 30
    for cnn_out_channels in (10, 20, 40, 80):
        print("CNN OUT CHANNELS {}".format(cnn_out_channels))
        cvlist = generate_cross_validataion_list()
        for i, cv in enumerate(cvlist):
            print("No. {} (TEST GROUP {}) STARTED".format(i, cv[2]))
            trainer = constructor(train_groups=cv[0],
...
def train_and_test_frame_window_and_cnn_out_channels_changing(constructor, device='cuda'):
...
def construct_trainer_0001(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda'):
    from .feature_extractor_0003 import FacialTurnDetectorFeatureExtractor0003
    ...
    facial_turn_detector = FacialTurnDetector0002(feature_extractor,
                                                  device=device)
    trainer = FacialTurnDetectorTrainerRinus0003(
...
def construct_trainer_0002(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda'):
    from .feature_extractor_0004 import FacialTurnDetectorFeatureExtractor0004
    from .facial_turn_detector_0002 import FacialTurnDetector0002

    feature_extractor = FacialTurnDetectorFeatureExtractor0004(
...
def construct_trainer_0003(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda'):
...
def construct_trainer_0004(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda'):
...
def construct_trainer_0005(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda'):
...
def construct_trainer_0006(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda'):
    from .feature_extractor_0006 import FacialTurnDetectorFeatureExtractor0006
...
def construct_trainer_0007(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda',
                           frame_window=10,
...
def construct_trainer_0008(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda',
                           frame_window=10,
...
def construct_trainer_0009(train_groups=list(range(3, 11)),
                           validation_group=1,
                           test_group=2,
                           device='cuda',
                           frame_window=10,
