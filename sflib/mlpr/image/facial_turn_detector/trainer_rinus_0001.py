...
class CrossEntropyLossForLSTM(nn.Module):
    def __init__(self):
        super().__init__()
        self.__cross_entropy_loss = nn.CrossEntropyLoss()
...
class FacialTurnDetectorTrainerRinus0001(FacialTurnDetectorTrainer):
    ...
    def build_torch_trainer(self, turn_detector: FacialTurnDetector):
        ...
        train_id_list = rinus_id_list[60:90]
...
def train(device='cuda'):
    ...
    facial_turn_detector = FacialTurnDetector0001(feature_extractor,
                                                  device=device)
    trainer = FacialTurnDetectorTrainerRinus0001(facial_turn_detector)
