...
# 顔画像オートエンコーダ関連
from ....img.face.feature.autoencoder.autoencoder_0001 \
    import FaceAutoEncoder0001 as FaceAutoEncoder
from ....img.face.feature.autoencoder.trainer_lfw_0001 \
    import FaceAutoEncoderTrainerLFW0001 as FaceAutoEncoderTrainer
from ....img.face.feature.autoencoder.base \
...
class FacialExpressionFeatureExtractor0001(FacialExpressionFeatureExtractor):
